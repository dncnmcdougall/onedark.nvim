...
local colors = {
    ...
    LightCyan = {fg = c.light_cyan},
    LightYellow = {fg = c.light_yellow},
    LightOrange = {fg = c.light_orange},
    LightGreen = {fg = c.light_green},
    LightBlue = {fg = c.light_blue},
...
hl.common = {
    ...
    FoldColumn = {fg = c.fg, bg = cfg.transparent and c.none or c.bg2},
...
hl.treesitter = {
    ["@annotation"] = colors.DarkBlue,
    ["@attribute"] = colors.DarkBlue,
    ["@boolean"] = colors.Red,
    ...
    ["@constant.builtin"] = colors.Yellow,
    ["@constant.macro"] = colors.Yellow,
    ...
    ["@field"] = colors.LightCyan,
    ["@float"] = colors.Red,
    ["@function"] = {fg = c.light_purple, fmt = cfg.code_style.functions},
    ["@function.builtin"] = {fg = c.yellow, fmt = cfg.code_style.functions},
    ["@function.macro"] = {fg = c.yellow, fmt = cfg.code_style.functions},
    ["@identifier"] = {fg = c.light_green, fmt = cfg.code_style.variables},
    ...
    ["@label"] = colors.Purple,
    ["@macro"] = colors.Yellow,
    ["@method"] = {fg = c.light_purple, fmt = cfg.code_style.functions},
    ["@method.call"] = {fg = c.light_purple, fmt = cfg.code_style.functions},
    ["@namespace"] = colors.Blue,
    ["@none"] = colors.Fg,
    ["@note"] = colors.Fg,
    ["@number"] = colors.Red,
    ["@operator"] = colors.Purple,
    ["@parameter"] = colors.light_green,
    ["@parameter.reference"] = colors.Fg,
    ["@pre.condit"] = colors.Yellow,
    ["@pre.proc"] = colors.Yellow,
    ["@property"] = colors.Cyan,
    ["@punctuation.bracket"] = colors.LightYellow,
    ["@punctuation.delimiter"] = colors.LightYellow,
    ...
    ["@string.escape"] = {fg = c.yellow, fmt = cfg.code_style.strings},
    ["@string.regex"] = {fg = c.yellow, fmt = cfg.code_style.strings},
    ["@symbol"] = colors.Cyan,
    ...
    ["@typedef"] = colors.Blue,
    ["@variable"] = {fg = c.light_green, fmt = cfg.code_style.variables},
...
hl.plugins.indent_blankline = {
    ...
    IndentBlanklineContextStart = { fg="none", bg="none", fmt = "italic" },
}
...
local lsp_kind_icons_color = {
    ...
    File = c.blue,
    Folder = c.orange,
    Function = c.light_purple,
    Interface = c.green,
    Key = c.cyan,
    Keyword = c.purple,
    Method = c.light_purple,
    Module = c.orange,
    Namespace = c.blue,
    Null = c.grey,
    Number = c.red,
